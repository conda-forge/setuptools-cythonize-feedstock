...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10491&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/setuptools-cythonize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `setuptools-cythonize` can be installed with:

```
conda install setuptools-cythonize
```

It is possible to list all of the versions of `setuptools-cythonize` available on your platform with:
